...
class starter {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		System.out.println("I'll give you a sentence and you have to type it as fast as you can!!\n\n--------------------------------------------");
		...
		if(x==1){
			...
			System.out.println("Errors : "+compareSentences(given, typed)+"/"+lettersInSentence(given)+" letters");
			System.out.println(lettersInSentence(given)/(endTimer()/60)+" letters per minute");
			System.out.println(wordsInSentence(given)/(endTimer()/60)+" words per minute");
		}
		else if(x==2){
			...
			sc.nextLine();
			System.out.println("\n------------------Your sentence is:------------------");
			String given = (getSentence(index));
			System.out.println(given);
			System.out.println("-----------------------------------------------------");
			countdown();
			startTimer();
